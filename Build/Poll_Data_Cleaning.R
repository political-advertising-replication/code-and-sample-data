...
### you may need to create an account here: https://uasdata.usc.edu/index.php

poll = read.csv('C:/Users/donggwan.kim/Desktop/Replication/Input Data/Daily_Polls.csv')
